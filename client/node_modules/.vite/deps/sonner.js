...
import { t as require_react_dom } from "./react-dom-Ich-6Xvc.js";
...
var kt = ({ visible: c }) => import_react.createElement("div", {
	className: "sonner-loading-wrapper",
	"data-visible": c
}, import_react.createElement("div", { className: "sonner-spinner" }, Lt.map((a, t) => import_react.createElement("div", {
	className: "sonner-loading-bar",
	key: `spinner-bar-${t}`
}))));
var zt = import_react.createElement("svg", {
...
var At = import_react.createElement("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 24 24",
	fill: "currentColor",
	height: "20",
...
var Yt = import_react.createElement("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 20 20",
	fill: "currentColor",
	height: "20",
...
var Bt = () => {
	let [c, a] = import_react.useState(!1);
...
var qt = (c) => {
	...
	let { invert: a, toast: t, unstyled: s, interacting: y, setHeights: g, visibleToasts: f, heights: m, index: r, toasts: Z, expanded: F, removeToast: _, closeButton: V, style: n, cancelButtonStyle: K, actionButtonStyle: tt, className: et = "", descriptionClassName: at = "", duration: X, position: B, gap: $ = Nt, loadingIcon: J, expandByDefault: z, classNames: l, closeButtonAriaLabel: ot = "Close toast", pauseWhenPageIsHidden: M } = c, [H, G] = import_react.useState(!1), [q, R] = import_react.useState(!1), [P, O] = import_react.useState(!1), [S, L] = import_react.useState(!1), [st, i] = import_react.useState(0), [p, h] = import_react.useState(0), N = import_react.useRef(null), x = import_react.useRef(null), u = r === 0, U = r + 1 <= f, v = t.type, D = t.dismissible !== !1, W = t.className || "", Dt = t.descriptionClassName || "", Q = import_react.useMemo(() => m.findIndex((o) => o.toastId === t.id) || 0, [m, t.id]), Pt = import_react.useMemo(() => {
		var o;
		return (o = t.closeButton) != null ? o : V;
	}, [t.closeButton, V]), ut = import_react.useMemo(() => t.duration || X || Kt, [t.duration, X]), nt = import_react.useRef(0), A = import_react.useRef(0), ft = import_react.useRef(0), Y = import_react.useRef(null), [mt, Ct] = B.split("-"), pt = import_react.useMemo(() => m.reduce((o, d, b) => b >= Q ? o : o + d.height, 0), [m, Q]), gt = Bt(), Ht = t.invert || a, rt = v === "loading";
	A.current = import_react.useMemo(() => Q * $ + pt, [Q, pt]), import_react.useEffect(() => {
		G(!0);
	...
	let C = import_react.useCallback(() => {
	...
	import_react.useEffect(() => {
		...
		if (o) {
			...
			return h(d), g((b) => [{
				...
				height: d,
				position: t.position
			}, ...b]), () => g((b) => b.filter((k) => k.toastId !== t.id));
		}
	}, [g, t.id]), import_react.useEffect(() => {
		t.delete && C();
	}, [C, t.delete]);
	function Rt() {
		return J ? import_react.createElement("div", {
			className: "sonner-loader",
			"data-visible": v === "loading"
		}, J) : import_react.createElement(kt, { visible: v === "loading" });
	}
	return import_react.createElement("li", {
		...
		onPointerDown: (o) => {
			rt || !D || (N.current = /* @__PURE__ */ new Date(), i(A.current), o.target.setPointerCapture(o.pointerId), o.target.tagName !== "BUTTON" && (O(!0), Y.current = {
				x: o.clientX,
				y: o.clientY
			}));
		},
	...
	}, Pt && !t.jsx ? import_react.createElement("button", {
		"aria-label": ot,
		"data-disabled": rt,
		"data-close-button": !0,
		onClick: rt || !D ? () => {} : () => {
		...
		x2: "18",
		y2: "18"
	}))) : null, t.jsx || import_react.isValidElement(t.title) ? t.jsx || t.title : import_react.createElement(import_react.Fragment, null, v || t.icon || t.promise ? import_react.createElement("div", { "data-icon": "" }, (t.promise || t.type === "loading") && !t.icon ? Rt() : null, t.icon || St(v)) : null, import_react.createElement("div", { "data-content": "" }, import_react.createElement("div", {
		"data-title": "",
	...
	}, t.description) : null), t.cancel ? import_react.createElement("button", {
		"data-button": !0,
		"data-cancel": !0,
	...
	}, t.cancel.label) : null, t.action ? import_react.createElement("button", {
		"data-button": "",
...
var ce = (c) => {
	let { invert: a, position: t = "bottom-right", hotkey: s = ["altKey", "KeyT"], expand: y, closeButton: g, className: f, offset: m, theme: r = "light", richColors: Z, duration: F, style: _, visibleToasts: V = _t, toastOptions: n, dir: K = Mt(), gap: tt, loadingIcon: et, containerAriaLabel: at = "Notifications", pauseWhenPageIsHidden: X } = c, [B, $] = import_react.useState([]), J = import_react.useMemo(() => Array.from(new Set([t].concat(B.filter((i) => i.position).map((i) => i.position)))), [B, t]), [z, l] = import_react.useState([]), [ot, M] = import_react.useState(!1), [H, G] = import_react.useState(!1), [q, R] = import_react.useState(r !== "system" ? r : typeof window != "undefined" && window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"), P = import_react.useRef(null), O = s.join("+").replace(/Key/g, "").replace(/Digit/g, ""), S = import_react.useRef(null), L = import_react.useRef(!1), st = import_react.useCallback((i) => $((p) => p.filter(({ id: h }) => h !== i.id)), []);
	return import_react.useEffect(() => T.subscribe((i) => {
		if (i.dismiss) {
			$((p) => p.map((h) => h.id === i.id ? {
				...h,
				delete: !0
		...
		if (P.current) return () => {
			S.current && (S.current.focus({ preventScroll: !0 }), S.current = null, L.current = !1);
		};
	}, [P.current]), B.length ? import_react.createElement("section", {
		"aria-label": `${at} ${O}`,
		tabIndex: -1
	}, J.map((i, p) => {
		var x;
		...
		return import_react.createElement("ol", {
			...
			onBlur: (u) => {
				L.current && !u.currentTarget.contains(u.relatedTarget) && (L.current = !1, S.current && (S.current.focus({ preventScroll: !0 }), S.current = null));
			},
			onFocus: (u) => {
...
//#endregion
export { ce as Toaster, Ut as toast };
